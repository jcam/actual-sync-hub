...
export function SaltEdgeConnectionCard({
  connection,
  onRefresh
}: {
  ...
  return (
    <article className="connection-card">
      <div className="connection-head">
        <div>
          <p className="eyebrow">Salt Edge connection</p>
      ...
      <div className="button-row">
        <button
          ...
          onClick={async () => {
            ...
            try {
              ...
              setError(
                getDisplayErrorMessage(refreshError, "Failed to refresh this Salt Edge connection.", {
                  serverUnavailableMessage: "Could not reach the API server to refresh this Salt Edge connection."
                })
              );
            } finally {
              setRefreshing(false);
        ...
        >
          {refreshing ? "Refreshing..." : "Refresh upstream data"}
        </button>
        <button
          className="ghost-button"
          ...
          onClick={async () => {
            ...
            try {
              ...
              setError(
                getDisplayErrorMessage(disconnectError, "Failed to disconnect this Salt Edge connection.", {
                  serverUnavailableMessage: "Could not reach the API server to disconnect this Salt Edge connection."
                })
              );
            } finally {
