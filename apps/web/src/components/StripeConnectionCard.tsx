        ...
        <button
          ...
          onClick={async () => {
            ...
            try {
              ...
              setError(
                getDisplayErrorMessage(refreshError, "Failed to refresh this Stripe connection.", {
                  serverUnavailableMessage: "Could not reach the API server to refresh this Stripe connection."
                })
              );
            } finally {
              setRefreshing(false);
        ...
        <button
          ...
          onClick={async () => {
            ...
            try {
              ...
              setError(
                getDisplayErrorMessage(disconnectError, "Failed to disconnect this Stripe connection.", {
                  serverUnavailableMessage: "Could not reach the API server to disconnect this Stripe connection."
                })
              );
            } finally {
